...
var Engine = (function(global) {
    ...
    function update(dt) {
        updateEntities(dt);
        //Player receives points for collecting items
        ...
        //Resets the player to starting position if the player hits an item.
        allRocks.forEach(function(rock){
          if (player.x < rock.x + rock.width &&
             player.x + player.width > rock.x &&
             player.y < rock.y + rock.height &&
             player.height + player.y > rock.y) {
       ...
       //Resets the player to starting position if the player hits an enemy.
